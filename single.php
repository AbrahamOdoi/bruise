...
if (isset($_POST['singleSend'])) {
	$msisdn = $_POST['singleMsisdn'];
	$subject = $_POST['singleSubject'];
	$message = $_POST['singleText'];
		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1> Single Message <small></small></h1>
					<ol class="breadcrumb">
						<li>
						...
						<div class="box-body">
							<form action="" method="post">
								<div class="form-group">
									<input type="text" required="required" class="form-control" name="singleMsisdn" placeholder="Send to:">
								</div>
								<div class="form-group">
									<input type="text" required="required" class="form-control" name="singleSubject" placeholder="Subject">
								</div>
								<div>
									<label>Message</label>
									<textarea name="singleText" required="required" style="display: inline-block; border-collapse: separate; border: 1px solid rgb(221, 221, 221); clear: none; float: none; margin: 0px; outline: rgb(51, 51, 51) none 0px; outline-offset: 0px; padding: 10px; position: static; top: auto; left: auto; right: auto; bottom: auto; z-index: auto; vertical-align: baseline; text-align: start; box-sizing: border-box; box-shadow: none; border-radius: 0px; width: 100%; height: 125px; background-color: rgb(255, 255, 255);"></textarea>
								</div>
								<div class="box-footer clearfix">
									<button type="submit" class="pull-right btn btn-default" id="singleSend" name="singleSend">
